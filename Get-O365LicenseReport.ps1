...
.DESCRIPTION 
    ...
    You have to install the Microsoft Online Services Sign-In Assistant and Windows Azure Active Directory Module
...
.PARAMETER 
    ...
    Change the $LogFile variable to your path
     
.OUTPUT 
    Office_365_License_service_report.csv will be written to the path configured 
 
.NOTES 
    Version:          1.0 
    Author:           Brian Timp
    Creation Date:    04 july 2017 
...
$LogFile = "G:\Office_365_License_service_report.csv" 
...
{     
    ...
    # Get a list of all the services in the tenant and add them to the header 
